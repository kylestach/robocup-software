...
def find_gap(target_pos=constants.Field.TheirGoalSegment.center(), max_shooting_angle=60, robot_offset=8, dist_from_point=.75):
    ...
    p3 = main.ball().pos
    main.debug_artist().draw_polygon([p1, p2, p3], (0, 0, 255), "Free Kick search zone")
    ...
    main.debug_artist().draw_line(robocup.Line(main.ball().pos, target_pos), (0, 255, 0), "Target Point")
    ...
    if windows:
        ...
        main.debug_artist().draw_line(robocup.Line(main.ball().pos, best_shot), (255, 255, 0), "Target Shot")
