...
class DefenseOld(composite_behavior.CompositeBehavior):
    ...
    def __init__(self, defender_priorities=[20, 19]):
        ...
        self.add_state(DefenseOld.State.clearing,
                       behavior.Behavior.State.running)
    ...
    def execute_running(self):
        ...
        if goalie.shell_id is None:
            ...
            #main.debug_artist().draw_circle(robocup.Point(0, 0), constants.Field.ArcRadius * 2,constants.Colors.Red, "Clear Ball")
        ...
        for idx, threat in enumerate(threats):
            ...
            if self.debug:
                for handler in threat.assigned_handlers:
                    ...
                    main.debug_artist().draw_circle(handler.move_target, 0.02,
                ...
                if threat.best_shot_window is not None:
                    ...
                    main.debug_artist().draw_polygon(pts, shot_color,
                                                     "DefenseOld")
                    main.debug_artist().draw_segment(
                ...
                if idx > 0:
                    ...
                    main.debug_artist().draw_line(
                        pass_line, constants.Colors.Red, "DefenseOld")
                    main.debug_artist().draw_text("Pass: " + str(
