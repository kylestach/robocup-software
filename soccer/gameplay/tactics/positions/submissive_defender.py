...
class SubmissiveDefender(
    ...
    def block_line(self, value):
        ...
        if self._block_line is not None:
            # main.debug_artist().draw_line(self._block_line, constants.Colors.White, "SubmissiveDefender")
            main.debug_artist().draw_circle(
    ...
    def execute_marking(self):
        ...
        if move.pos is not None:
            main.debug_artist().draw_circle(move.pos, 0.02,
                                            constants.Colors.Green, "Mark")
            main.debug_artist().draw_segment(left_seg, constants.Colors.Green,
                                             "Mark")
            main.debug_artist().draw_segment(top_seg, constants.Colors.Green,
                                             "Mark")
            main.debug_artist().draw_segment(right_seg, constants.Colors.Green,
                                             "Mark")
