...
class Defender(single_robot_behavior.SingleRobotBehavior):
    ...
    def execute_marking(self):
        #main.debug_artist().draw_line(robocup.Line(self._area.get_pt(0), self._area.get_pt(1)), (127,0,255), "Defender")
    ...
    def execute_area_marking(self):
        ...
        if best is not None:
            ...
            main.debug_artist().draw_line(shootline, (255, 0, 0), "Defender")
