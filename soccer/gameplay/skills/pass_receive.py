...
class PassReceive(single_robot_composite_behavior.SingleRobotCompositeBehavior
    ...
    def execute_running(self):
        ...
        if self._pass_line != None:
            main.debug_artist().draw_line(self._pass_line,
                                          constants.Colors.Blue, "Pass")
            main.debug_artist().draw_circle(self._target_pos, 0.03,
                                            constants.Colors.Blue, "Pass")
    ...
    def check_failure(self):
        ...
        main.debug_artist().draw_raw_polygon(good_area, constants.Colors.Green,
                                             "Good Pass Area")
